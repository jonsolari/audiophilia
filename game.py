...
parts = {
    ...
    94: Section('You calmly (you think) walk into the shop, but Phil is nowhere to be found. You see Jeff though, and wave him over. He tells you that Phil stepped out.', ['1) "Well do you know when he\'ll be back?"'], [95]),
    ...
    98: Section('You try your best to center yourself but you\'re in a dark-ass place now. Except whoa shit wait, when did they get a laserdisc section..!? You didn\'t even see that before.', ['1) Makes sense, they\'re identical to LPs when shelved.'], [99]),
    99: Section('There\'s even some CEDs!', ['1) Look through those.', '2) What is a CED?'], [100, 101]),
    100: Section('Oh damn they have Let It Be! In all its overhyped mild-awkwardness. This is basically unaffordable in any other home video format. ', ['1) I should grab it.'], [102]),
    101: Section('Oh man dude, CEDs are interesting as hell, they\'re like this worse-quality-than-VHS disc that\'s basically a vinyl record, but for video. It lives in this big plastic housing but once it\'s in the machine there\'s a stylus that goes into a groove on the disc, and it can even skip like a record (and used ones almost always do), it\'s a whole thing.', ['1) Well are there any good titles?'], [100]),
    102: Section('You would, but there\'s no time for that-- Phil just got back', ['1) Go confront him.'], [103]),
