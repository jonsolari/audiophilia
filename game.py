...
parts = {
    ...
    19: Section('Moving Pictures, unimpeachable man, truly unimpeachable. How do you get two songs like Tom Sawyer and Limelight on the same record, it\'s almost unfair. That\'s some Mark McGuire, Sammy Sosa shit. Just firin\' em off.', ['1) "Oh really? Nice. That\'s cool man."', '2) "Yes. I know all this."', '3) Silence. Stonewall him until he runs out of gas.'], [21, 22, 23]),
