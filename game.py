...
parts = {
    ...
    82: Section('You keep on driving. You can\'t tell if the whining noise is getting worse or if it\'s just your imagination, but it\'s probably a good idea to get it checked out sooner than later. \n\nYou pull into John\'s Garage.', ['1) Go see if John has some time today to look at it.'], [84]),
...
while True:
    ...
    for i in parts[current].opt:
        print('\033[90m'+linebreaks(i)+'\033[0m')
